      ...
      {selected ? (
        ...
        <>
              ...
              <div className="mt-2 flex flex-wrap items-end justify-center gap-3">
                {celebrate.map((s) => (
                  <div key={s.id} className="flex flex-col items-center">
                    <ProceduralTree dna={dnaOf(s)} stage={s.stage} pixel={3} className="animate-pixel-pop" />
          ...
          <p className="text-center text-xs text-brown/50">
            Every varietal is drawn by the same generator that grows your trees. Unlocks are pure reward, and
