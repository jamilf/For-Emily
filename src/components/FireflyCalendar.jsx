  ...
  return (
    ...
    >
      <p className="text-sm text-fg/80">
        Every completed focus session lights one firefly in your meadow. This is a record of when you tended
        your grove. Quiet days are simply quiet, never a failure.
      </p>
