...
// A depth band: a full-bleed wrapper whose children keep their absolute positions,
// but the whole group shifts a few px with the parallax vars (nearer bands use a
