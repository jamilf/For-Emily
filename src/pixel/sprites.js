...
export const PAL = {
  // greens
  G: '#A7C080', g: '#6f8c4f', k: '#4f6a3a', H: '#A7C080', h: '#4f6a3a',
  // warm accents
  Y: '#DBBC7F', P: '#D699B6', R: '#E67E80', O: '#E69875', A: '#83C092', B: '#7FBBB3',
  o: '#DBBC7F', // moon
  // neutrals / wood
  w: '#FDF6E3', u: '#EFEBD4', m: '#8F5E36', d: '#6E4527', s: '#5e4327', S: '#7a5638',
  p: '#8F5E36',
  // night / soot
  n: '#3A4750', N: '#4a5a64', b: '#20272b',
  '.': '#7FBBB3', // rain / stars
}
